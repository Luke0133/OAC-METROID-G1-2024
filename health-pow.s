...
.text
SETUP:		la a0,numbers			# carrega o endereco do sprite 'map' em a0
		li a1,0				# x = 0
		li a2,0				# y = 0
		li a3,0				# frame = 0
...
GAME_LOOP:	call KEY2			# chama o procedimento de entrada do teclado
		...
		la a0,weapons			# carrega o endereco do sprite 'char' em a0
		...
		la a0,energy			# carrega o endereco do sprite 'tile' em a0
...
.data
.include "sprites/.s/energy.s"
.include "sprites/.s/weapons.s"
.include "sprites/.s/numbers.s"